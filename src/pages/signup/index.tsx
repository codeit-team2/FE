  ...
  return (
    <>
      ...
      <div className="border-b-8 border-b-neutral-50 bg-white px-20 pb-50 pt-32">
        <p className="mb-32 text-center text-heading-2Sb">회원가입</p>
        <FormProvider {...form}>
          <form
            autoComplete="off"
            ...
            <div className="scroll h-full overflow-y-auto">
              <div className="flex h-full flex-col gap-50">
                ...
                <div>
                  ...
                  <Button
                    className={`mb-32 w-full ${(!isValid || !isValidated.agree) && 'cursor-default bg-neutral-400 !text-neutral-100 hover:!text-neutral-100'}`}
                    variant="secondary"
                    type="submit"
                  >
                    회원가입
