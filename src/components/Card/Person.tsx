    ...
    <>
      {data.participantCount > 5 ? (
        <div className="flex items-center gap-2">
          ...
          <div className="mr-8 text-body-2Sb text-primary-300">{data.participantCount}/20</div>
        </div>
      ) : (
        <div className="flex items-center gap-2">
          <Image src="/icons/ic-person-gray.svg" alt="ic-person-gray" width={24} height={24} />
          <div className="mr-8 text-body-2Sb text-neutral-500">{data.participantCount}/20</div>
        </div>
      )}
    </>
  );
